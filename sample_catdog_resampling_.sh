...
do
    ...
    --use_slerp_noise $NUM_NOISES --mask_blur_sigma 4.0 --mask_type "rectangular" --global_refine_steps 10 --global_refine_guidance 1 --global_refine_sigma 0.05 \
